...
# .env.example file at the root of frontend
FRONTEND_ENV_EXAMPLE_FILE="${PWD}/apps/frontend/.env.example"
FRONTEND_ENV_FILE="${PWD}/apps/frontend/.env"
...
if [ $DOMAIN ]; then
    ...
    ./scripts/create-etc-hosts-entry.sh "admin.${DOMAIN}"
